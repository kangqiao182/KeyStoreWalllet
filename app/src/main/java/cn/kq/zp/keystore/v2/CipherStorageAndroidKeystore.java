...
final class CipherStorageAndroidKeystore extends BaseCipherStorage {
     ...
     */
    @Override
    public void encrypt(String alias, String password, String value) {
        try {
            ...
            generator.init(generateParameterSpec(alias), sr);
    ...
    @Nullable
    @Override
    public String decrypt(String alias, String password) {
        try {
            KeyStore keyStore = getKeyStoreAndLoad();
            ...
            String ret = decryptBytes(key, storedData);
            return ret;
